...
func (x *RateLimitQuotaUsageReports_BucketQuotaUsage) GetTimeElapsed() *duration.Duration {
	if x != nil {
...
type RateLimitQuotaResponse_BucketAction_QuotaAssignmentAction struct {
	...
	AssignmentTimeToLive *duration.Duration `protobuf:"bytes,2,opt,name=assignment_time_to_live,json=assignmentTimeToLive,proto3" json:"assignment_time_to_live,omitempty"`
...
func (x *RateLimitQuotaResponse_BucketAction_QuotaAssignmentAction) GetAssignmentTimeToLive() *duration.Duration {
	if x != nil {
...
var file_envoy_service_rate_limit_quota_v3_rlqs_proto_rawDesc = []byte{
	...
	0x01, 0x30, 0x01, 0x42, 0xab, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0xd2, 0xc6,
	0xa4, 0xe1, 0x06, 0x02, 0x08, 0x01, 0x0a, 0x2f, 0x69, 0x6f, 0x2e, 0x65, 0x6e, 0x76, 0x6f, 0x79,
