...
type InternalListener struct {
	...
	BufferSizeKb *wrappers.UInt32Value `protobuf:"bytes,1,opt,name=buffer_size_kb,json=bufferSizeKb,proto3" json:"buffer_size_kb,omitempty"`
}
...
func (x *InternalListener) GetBufferSizeKb() *wrappers.UInt32Value {
	if x != nil {
