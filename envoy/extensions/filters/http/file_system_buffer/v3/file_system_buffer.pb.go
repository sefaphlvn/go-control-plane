...
type StreamConfig struct {
	...
	MemoryBufferBytesLimit *wrappers.UInt64Value `protobuf:"bytes,2,opt,name=memory_buffer_bytes_limit,json=memoryBufferBytesLimit,proto3" json:"memory_buffer_bytes_limit,omitempty"`
	...
	StorageBufferBytesLimit *wrappers.UInt64Value `protobuf:"bytes,3,opt,name=storage_buffer_bytes_limit,json=storageBufferBytesLimit,proto3" json:"storage_buffer_bytes_limit,omitempty"`
...
var file_envoy_extensions_filters_http_file_system_buffer_v3_file_system_buffer_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0xdd, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02, 0x10, 0x02, 0xd2, 0xc6, 0xa4, 0xe1,
