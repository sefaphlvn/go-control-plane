...
func (x *UdpProxyConfig_UdpTunnelingConfig) GetProxyPort() *wrappers.UInt32Value {
	if x != nil {
		return x.ProxyPort
	}
	return nil
...
func (x *UdpProxyConfig_UdpTunnelingConfig_BufferOptions) GetMaxBufferedDatagrams() *wrappers.UInt32Value {
	if x != nil {
...
func (x *UdpProxyConfig_UdpTunnelingConfig_BufferOptions) GetMaxBufferedBytes() *wrappers.UInt64Value {
	if x != nil {
...
func (x *UdpProxyConfig_UdpTunnelingConfig_RetryOptions) GetMaxConnectAttempts() *wrappers.UInt32Value {
	if x != nil {
...
var file_envoy_extensions_filters_udp_udp_proxy_v3_udp_proxy_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0xb0, 0x01, 0xba, 0x80, 0xc8, 0xd1, 0x06, 0x02,
	...
	0x64, 0x70, 0x5f, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x76, 0x33, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
