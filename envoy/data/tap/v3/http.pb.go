...
type HttpBufferedTrace_Message struct {
	...
	HeadersReceivedTime *timestamp.Timestamp `protobuf:"bytes,4,opt,name=headers_received_time,json=headersReceivedTime,proto3" json:"headers_received_time,omitempty"`
}
...
func (x *HttpBufferedTrace_Message) GetHeadersReceivedTime() *timestamp.Timestamp {
	if x != nil {
